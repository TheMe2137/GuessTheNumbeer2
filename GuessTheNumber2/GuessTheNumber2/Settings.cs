...
public class Settings       //class having setting related objects
{
    ...
    {
        Gui.PrintText(Language.Get("settings_show"));   //prints out settings gui
        int choice;
    ...
    public static void ChangeLanguage()     //method to change language
        {
            Gui.PrintText(Language.Get("sellang"));
            int languageChoice;
    ...
    {
        Gui.PrintText(Language.Get("selllimit"));
    ...
    {
        Gui.PrintText(Language.Get("clearq"));
