...
{
    public static string CurrentLanguage = "pl";        //default polish

    public static string Get(string key)    //class to change the language between english and polish
    {
        ...
        return key;     //returns what u chose polish or english case valule
    }
}
